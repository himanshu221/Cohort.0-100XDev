...
Create the following functionality - 
 ...
 - Just try to put over our original HTML/JS impelementation over to a React project
 ...
 ## This folder contains the solution for Hard todo front-end with using states, components and jsx syntax.